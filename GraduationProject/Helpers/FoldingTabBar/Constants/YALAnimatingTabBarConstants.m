...
CGFloat const YALTabBarViewDefaultHeight = 60.f;
CGFloat const YALExtraTabBarItemsDefaultHeight = 35.f;
CGFloat const YALForExtraTabBarItemsDefaultOffset = 15.f;
UIEdgeInsets const YALTabBarViewHDefaultEdgeInsets = {8.f, 8.f, 8.f, 8.f};
