...
-(void)didMoveToSuperview{
    ...
    imgView.layer.cornerRadius = self.height/2.0;
...
-(void)changeFrameWithPoint:(CGPoint)point{
    ...
    [UIView animateWithDuration:0.4 delay:0.5 usingSpringWithDamping:0.8 initialSpringVelocity:0 options:0 animations:^{
